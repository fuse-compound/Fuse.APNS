...
namespace Fuse.APNS
{
	[Require("Entity", "Fuse.APNS.iOSImpl.OnNotificationRegistrationSucceeded(string)")]
	[Require("Entity", "Fuse.APNS.iOSImpl.OnNotificationRegistrationFailed(string)")]
	[Require("Entity", "Fuse.APNS.iOSImpl.OnReceivedNotification(string,bool)")]
	...
	[Require("uContext.SourceFile.Declaration", "#include <AppDelegateAPNService.h>")]
	extern(iOS)
